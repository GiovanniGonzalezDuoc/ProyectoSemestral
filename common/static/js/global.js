...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateForm() {
      ...
      const isCardYearValid = cardYear.length === 2; // Año debe tener exactamente 2 dígitos
    ...
    document.getElementById('paymentForm').addEventListener('submit', function(e) {
      ...
      // Iterate over fields and highlight empty ones
      ...
      // If any field is empty, focus on the first empty field
      if (firstEmptyField) {
      ...
      // Example: Submit form using AJAX or navigate to another page
